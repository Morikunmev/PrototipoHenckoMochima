const ui = {
  ...
  renderTable: (products) => {
    ...
    console.log(`📋 [UI] Renderizando tabla con ${products.length} productos`);
    ...
    performanceLogger.endTimer(
      renderTimer,
      `${products.length} filas renderizadas`
    );
  },
  ...
  renderPricing: (products) => {
    ...
    let html = `
      <div class="pricing-summary">
        ...
        <p style="color: #4CAF50;"><strong>Potencial de ingresos:</strong> ${ui.formatCLP(
          pricing.totalPotentialRevenue
        )}</p>
      </div>
    `;
